...
let tgtDiv=document.getElementById('content')
document.body.insertBefore(newDiv,tgtDiv)
let str='<div style="position: absolute; right: 50%; margin-right: 260px; top:120px; "><a href="/@" rel="nofollow"><img src="images/style/facebook.svg"></a></div>'
newDiv.innerHTML=str}}}
...
let links=[['/@','Home',0],['/@','Algebra',0],['/@','Calculus',1],['/@','Data',0],['/@','Geometry',0],['/@','Measure',0],['/@','Money',1],['/@','Numbers',0],['/@','Physics',0],['/@','Activities',1],['/@','Dictionary',0],['/@','Games',0],['/@','Puzzles',0],['worksheets/index.php','Worksheets',1],]
let s=''
...
s+=linkstt+'/@'+url+'&t='+title+'" title="Share on Facebook" id="linkfb"></a> '
s+=linkstt+'/@'+url+'&text='+title+':%20'+url+'" title="Tweet it" id="linktw"></a> '
s+=linkstt+'/@'+url+'&description='+title+'" title="Pin it" id="linkpi"></a>'
...
s+='<form autocomplete="off" action="'+urlSttGet()+'/@" method="get">'
